...
//  InteractiveStory
//
//  Created by Julia Friberg on 2017-04-19.
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "startAdventure" {
            ...
            do {
                ...
                let alertController: UIAlertController = UIAlertController(title: "Name not provided", message: "Provide a name to start the story", preferredStyle: .alert)
